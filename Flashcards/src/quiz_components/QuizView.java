...
public class QuizView extends JFrame implements KeyListener, ActionListener {
    ...
    public QuizView() {
        ...
        this.card = Card1.getCardImage();
        this.card.setBorder(BorderFactory.createCompoundBorder(cardMargin,
                cardBorder));
    ...
    public final void showCorrect(boolean isCorrect, String correctAnswer) {
         ...
         */
        if (isCorrect) {
            this.card.setText("Correct!");
        } else {
            this.card.setText("<html><center>Wrong! "
    ...
    public final void setCard(Card c) {
        this.card.setText(c.getFronthtml());
    }
